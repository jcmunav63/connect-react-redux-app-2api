# Connect React-Redux App to an API
...
<!-- PROJECT DESCRIPTION -->
# 📖 [About the Project - Connect a REACT-REDUX App to an API] <a name="about-project"></a>

**Bookstore** It's a simple website React-Redux app to connect to an API.
...
- **Redux for variable and state sharing**
- **Fetch data from API**
...
```sh
  ...
  git clone git@github.com:jcmunav63/connect-react-redux-app-2api.git
```
...
```sh
  cd connect-react-redux-app-2api
...
The Connect a React-Redux App to an API App will include the following features:
